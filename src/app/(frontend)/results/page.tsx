  ...
  return (
    <div className="grow p-3 flex flex-col gap-3 items-center pt-5">
      {/* <div className="rounded-box border-accent border p-3 relative py-5">
        ...
        {(results?.image as Media)?.url && (
          <div className="avatar float-left mr-3 mb-2 w-24">
            <div className="w-24 h-24 rounded overflow-hidden relative">
              <Image
                fill
                src={(results?.image as Media)?.url as string}
                alt={(results?.image as Media)?.alt as string}
        ...
        <div className="leading-relaxed text-justify">{results?.description}</div>

        <div className="clear-both" />
      </div> */}
      <SectionHeader section={results as any} />

      <div className="mt-6 w-full items-center flex flex-col gap-3">
